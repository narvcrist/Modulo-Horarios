...
jQuery(document).ready(function(){
   ...
   var numero='<?php echo !empty($sol->PERXLIC_SECUENCIAL) ? prepCampoMostrar($sol->PERXLIC_SECUENCIAL) : null ; ?>';
...
$("#fperxlic").validate({
       ...
       submitHandler: function(form){
           $.ajax({
               type: "POST",
               url:  "perxlic/admPerxlic/"+accion,
               data: $("#fperxlic").serialize(),
               dataType:"json",
               success: function(r){
                       if (r.cod>0) {
                           $("#fperxlic").jConfirmacion({
                                        titulo:"Perxlic: "+r.numero,
                                        mensaje: r.mensaje,
                           ...
                           if (accion=='n'){
                                $("#PERXLIC_SECUENCIAL").val(r.numero);
								}
                                $("#co_grabar").hide();
                       } else {
