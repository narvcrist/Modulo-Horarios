...
jQuery(document).ready(function(){
    ...
    jQuery("#itemapo").jqGrid({
          ...
          colModel:[
					...
					{name:'APO_SEC_MATRICULA',index:'APO_SEC_MATRICULA',align:"center",  width:80},
                    {name:'APO_SEC_PERSONA',index:'APO_SEC_PERSONA',align:"center",width:60},
					...
					{name:'APO_FECHALIMITE',index:'APO_FECHALIMITE',align:"center",  width:80},
