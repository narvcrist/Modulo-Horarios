...
jQuery(document).ready(function(){
    ...
    jQuery("#itemapo").jqGrid({
          ...
          datatype: "json",
          colNames:['Num','Sec','Fecha Ingreso','Matrícula','Persona','Nota 1','Nota 2','Nota 3','Nota 4',
					'Total Adquirido','Fecha Límite','Resp. Crea','Resp. Edita','Estado'],
          colModel:[
					...
					{name:'APO_FECHAINGRESO',index:'APO_FECHAINGRESO',align:"center",  width:100},
