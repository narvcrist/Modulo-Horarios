...
class Persona extends CI_Controller{
	...
	function datos($sol,$accion){
        if ($accion=='n') {
			...
			$LOC_PROVINCIA_NACIMIENTO=$this->provincia_residencia($LOC_CIUDAD_NACIMIENTO);
            ...
            $datos['combo_ciudad_nacimiento']=$this->cmb_ciudad_nacimiento($LOC_CIUDAD_ESTUDIOS,$LOC_PROVINCIA_NACIMIENTO," style='width:150px;' id='LOC_CIUDAD_NACIMIENTO'");
	...
	function cmb_ciudad_residencia($LOC_SECUENCIAL = null, $LOC_PROVINCIA = null,$attr = null){
        if (($LOC_SECUENCIAL == null) and ($LOC_PROVINCIA == null)) {
            ...
            if ($query->num_rows() > 0) {
                ...
                return alerta("No Posee Ciudades. <input type='hidden' name='ciudad_resisdncia' value='' />");
            }
		}
	}
