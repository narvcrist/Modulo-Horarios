...
class Ingreso extends CI_Controller  {
	...
	public function login (){
	  ...
	  if($this->input->post('login')) {		  
		...
		//$this->session->set_flashdata('message', '<font color="#f04e24"><b>Usuario o Clave Incorrecta</b></font>');
		$this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert" ><button class="close" type="button" data-dismiss="alert"><span aria-hidden="true">×</span><span class="sr-only">Cerrar</span></button><strong><font color="#f04e24"><b>Usuario o Clave Incorrecta</font><strong></div>');
		redirect('');
