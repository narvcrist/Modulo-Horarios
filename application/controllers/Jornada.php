...
class Jornada extends CI_Controller{
	...
	public function nuevaJornada(){     
        ...
        if ($accion=='n') {
            ...
            $datos['combo_paralelo']=$this->cmb_paralelo(null,null," style='width:100px;' id='JOR_PARALELO'");
            $datos['combo_jornada']=$this->cmb_jornada(null,null," style='width:100px;' id='JOR_NOMBRE'");

        }else{
            //Caso para la edicion de una jornada
            $paralelo=$sol->JOR_PARALELO;
            $datos['combo_paralelo']=$this->cmb_paralelo($paralelo,$sol->JOR_PARALELO," style='width:100px;' id='JOR_PARALELO'");				
            $jornada=$sol->JOR_NOMBRE;
            $datos['combo_jornada']=$this->cmb_jornada($jornada,$sol->JOR_NOMBRE," style='width:100px;' id='JOR_NOMBRE'");				
    ...
    function  cmb_paralelo($tipo = null, $attr = null) {
        $output = array();
        $output[null] = "Paralelo";
        $output['A'] = "Paralelo A";
        $output['B'] = "Paralelo B";
        $output['C'] = "Paralelo C";
        return form_dropdown('paralelo', $output, $tipo, $attr);
    }
