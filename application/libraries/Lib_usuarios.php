...
class Lib_usuarios {
    ...
    private function getUsuarioPerfil($US_CODIGO = null){
     ...
     public function getAccesoSeccion($UXR_UCOD = null,$USD_ALIAS = null){
        $CI =& get_instance();
		$sql="SELECT USP_SECUENCIAL FROM ISTCRE_APLICACIONES.VW_USUARIOSXDIRXPER WHERE APLICACION='SIACIS_DES' AND USUARIO='$UXR_UCOD' AND ALIAS='$USD_ALIAS'";
    ...
    public function getElementoAcceso($US_CODIGO = null,$USD_SECUENCIAL = null){
        ...
        $value = $CI->db->select("USP_ELEMENTO")
                 ...
                 ->get("ISTCRE_APLICACIONES.PERMISOS")
                 ->row_array();
